package com.sixcandoit.userservice.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sixcandoit.userservice.dto.UserDTO;
import com.sixcandoit.userservice.service.UserService;
import com.sixcandoit.userservice.vo.RequestLogin;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String email = ((User)authResult.getPrincipal()).getUsername();      // 실제로는 email 값이 나옴
